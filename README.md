...
- **投喂记录列表**：卡片展示日期、地点、猫粮种类、投喂量、备注预览；每条卡片日期旁显示天气标签（有值时），天气对应颜色：☀️晴天/黄、☁️阴天/灰、🌧️雨天/蓝、❄️雪天/青
- **单条详情**：完整展示记录全部字段（含天气，未记录时显示"未记录"），标题旁显示天气标签；页面下方提供投喂时间线，支持切换「同地点 / 全部」范围，按日期倒序展示记录，每条时间线项目标题旁显示天气标签，当前记录高亮为橙色并标注「当前」徽章，非当前记录可点击跳转
